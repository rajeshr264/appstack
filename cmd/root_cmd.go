...
var rootCmd = &cobra.Command{
	Use:   "ephstack",
	Short: "Manage a stack deployed in hybrid cloud",
	Long: `Manage a stack deployed in hybrid cloud`,
...
func init() {
	...
	//rootCmd.PersistentFlags().StringVar(&stackFile, "stack", "", "stack file in YAML format")
}
